            ...
            <section class="express">
                <div class="container tc">
                    ...
                    <p style="text-align: justify;">
                        ...
                        а) Политика конфиденциальности, размещенная и/или доступная в сети Интернет по адресу https://samp-bet.ru/docs/policy, которая содержит правила предоставления и использования конфиденциальной информации, включая персональные данные Пользователя.<br>
                    ...
                    <p style="text-align: justify;">
                        ...
                        5.4. Действующая редакция настоящего Соглашения размещена на Сайте Правообладателя и доступна в сети Интернет по адресу https://samp-bet.ru/docs.<br>
                    ...
                    <p style="text-align: justify;">
                        ...
                        Вывод средств осуществляется по вашему запросу (<a href="https://samp-bet.ru/panel/withdraw">в личном кабинете</a>).<br>Запрос на вывод направляется в Interkassa.com (API) и обработка может составить от 1 до 5 рабочих дней.
                    ...
                    <p style="text-align: justify;">
                        ...
                        <i>Для отмены или возврата нужно обратиться по доступным <a href="https://samp-bet.ru/contacts">контактным данным</a> и сообщить о отмене или же возврату платежа, ожидать ответа оператора.</i>
                    @endif
                </div>
            </section>
@endsection